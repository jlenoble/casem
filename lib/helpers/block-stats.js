  ...
  _createClass(DoStat, [{
    ...
    value: function reduce() {
      ...
      return new Promise(function (resolve, reject) {
        setTimeout(function () {
          try {
            resolve(_get(DoStat.prototype.__proto__ || Object.getPrototypeOf(DoStat.prototype), 'reduce', _this2).call(_this2));
          } catch (err) {
            reject(err);
          }
        });
...
var ForStat = exports.ForStat = function (_Block2) {
  ...
  function ForStat(ctx, visitor, parent) {
    _classCallCheck(this, ForStat);

    var _this3 = _possibleConstructorReturn(this, (ForStat.__proto__ || Object.getPrototypeOf(ForStat)).call(this, ctx, visitor, parent));
      ...
      var promise = new Promise(function (resolve, reject) {
        setTimeout(function () {
          try {
            ...
            resolve(_get(ForStat.prototype.__proto__ || Object.getPrototypeOf(ForStat.prototype), 'reduce', _this4).call(_this4));
          } catch (err) {
            reject(err);
          }
        });
        ...
        setTimeout(function () {
          try {
            if (_this8.visitor.visit(_this8.ctx.boolExpr())) {
              resolve(_get(WhileStat.prototype.__proto__ || Object.getPrototypeOf(WhileStat.prototype), 'reduce', _this8).call(_this8));
            } else {
              resolve(BREAK);
            }
          } catch (err) {
