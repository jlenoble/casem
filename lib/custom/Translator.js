...
var Translator = exports.Translator = function (_CalcListener) {
  ...
  _createClass(Translator, [{
    ...
    value: function enterBlock(ctx) {
      this.currentBlock = new _block2.default(ctx, visitor, this.currentBlock);
    }
  }, {
    key: 'exitBlock',
    ...
    value: function enterDoStat(ctx) {
      this.currentBlock = new _blockStats.DoStat(ctx, visitor, this.currentBlock);
    }
  }, {
    key: 'exitDoStat',
    ...
    value: function enterFile(ctx) {
      this.currentBlock = new _file2.default(ctx, visitor);
    }
  }, {
    key: 'exitFile',
    ...
    value: function enterForStat(ctx) {
      this.currentBlock = new _blockStats.ForStat(ctx, visitor, this.currentBlock);
    }
  }, {
    key: 'exitForStat',
    ...
    value: function enterIfStat(ctx) {
      this.currentBlock = new _blockStats.IfStat(ctx, visitor, this.currentBlock);
    }
  }, {
    key: 'exitIfStat',
    ...
    value: function enterProg(ctx) {
      this.main = new _file2.default(ctx, visitor);
      this.currentBlock = this.main;
    }
  }, {
    key: 'exitProg',
    value: function exitProg(ctx) {
      ...
      setTimeout(function () {
        ...
        try {
          _this2.resolve(_this2.currentBlock.reduce());
        } catch (err) {
          _this2.reject(err);
        }
      });
    ...
    value: function enterStat(ctx) {
      if (!this.isImplyStat) {
        ...
        this.currentBlock.push(new _stat2.default(ctx, visitor));
      }
    ...
    value: function enterWhileStat(ctx) {
      this.currentBlock = new _blockStats.WhileStat(ctx, visitor, this.currentBlock);
    }
  }, {
    key: 'exitWhileStat',
