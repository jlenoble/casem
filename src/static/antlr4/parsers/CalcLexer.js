...
CalcLexer.prototype.literalNames = [ null, "','", "'('", "')'", "':'", "'File Name'", 
...
CalcLexer.prototype.symbolicNames = [ null, null, null, null, null, null, 
                                      null, null, null, "ID", "NATNUM", 
                                      "TEXT", "NEWLINE", "STRING", "ZERO", 
                                      "SQRT", "COS", "SIN", "TAN", "ACOS", 
                                      "ASIN", "ATAN", "ADD", "SUB", "MUL", 
                                      "DIV", "EQ", "NE", "GT", "GE", "LT", 
...
CalcLexer.prototype.ruleNames = [ "T__0", "T__1", "T__2", "T__3", "T__4", 
                                  "T__5", "T__6", "T__7", "ID", "NATNUM", 
                                  "TEXT", "NEWLINE", "STRING", "ZERO", "SQRT", 
                                  "COS", "SIN", "TAN", "ACOS", "ASIN", "ATAN", 
                                  "ADD", "SUB", "MUL", "DIV", "EQ", "NE", 
                                  "GT", "GE", "LT", "LE", "AND", "OR", "ARROW", 
                                  "FATARROW", "ELSE", "GOTO", "IF", "IFEND", 
                                  "LBL", "LOCATE", "PI", "PROG", "RETURN", 
                                  "THEN" ];
