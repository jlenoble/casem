...
Keywords.prototype.literalNames = [ null, "'\\->'", "'\\cos '", "'\\Locate '", 
                                    "'\\Pi'", "'\\sin '", "'\\tan '" ];

Keywords.prototype.symbolicNames = [ null, "ARROW", "COS", "LOCATE", "PI", 
                                     "SIN", "TAN" ];

Keywords.prototype.ruleNames = [ "ARROW", "COS", "LOCATE", "PI", "SIN", 
                                 "TAN" ];
