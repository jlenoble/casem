...
Keywords.prototype.literalNames = [ null, "'\\Else '", "'\\Goto'", "'\\If '", 
                                    "'\\IfEnd'", "'\\Lbl '", "'\\Locate '", 
                                    "'\\Pi'", "'\\Return'", "'\\Then '" ];

Keywords.prototype.symbolicNames = [ null, "ELSE", "GOTO", "IF", "IFEND", 
                                     "LBL", "LOCATE", "PI", "RETURN", "THEN" ];

Keywords.prototype.ruleNames = [ "ELSE", "GOTO", "IF", "IFEND", "LBL", "LOCATE", 
                                 "PI", "RETURN", "THEN" ];
