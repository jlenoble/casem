...
StatsLexer.DOT = 11;
StatsLexer.EQUAL = 12;
StatsLexer.GETKEY = 13;
StatsLexer.LOCATE = 14;
StatsLexer.LOOPWHILE = 15;
StatsLexer.MUL = 16;
StatsLexer.SUB = 17;
...
StatsLexer.prototype.literalNames = [ null, null, null, null, null, "'+'", 
                                      "'\\->'", "':'", "','", "'/'", "'\\Do'", 
                                      "'.'", "'='", "'\\Getkey'", "'\\Locate '", 
                                      "'\\LpWhile '", "'*'", "'-'" ];
...
StatsLexer.prototype.ruleNames = [ "ID", "UINT", "STRING", "NEWLINE", "ADD", 
