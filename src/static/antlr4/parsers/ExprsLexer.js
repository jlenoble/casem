...
ExprsLexer.DOT = 11;
ExprsLexer.EQUAL = 12;
ExprsLexer.GETKEY = 13;
ExprsLexer.LOCATE = 14;
ExprsLexer.LOOPWHILE = 15;
ExprsLexer.MUL = 16;
ExprsLexer.SUB = 17;
...
ExprsLexer.prototype.literalNames = [ null, null, null, null, null, "'+'", 
                                      "'\\->'", "':'", "','", "'/'", "'\\Do'", 
                                      "'.'", "'='", "'\\Getkey'", "'\\Locate '", 
                                      "'\\LpWhile '", "'*'", "'-'" ];
...
ExprsLexer.prototype.ruleNames = [ "ID", "UINT", "STRING", "NEWLINE", "ADD", 
                                   "ARROW", "COLON", "COMMA", "DIV", "DO", 
                                   "DOT", "EQUAL", "GETKEY", "LOCATE", "LOOPWHILE", 
                                   "MUL", "SUB" ];
