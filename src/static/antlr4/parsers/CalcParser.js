...
CalcParser.DOT = 17;
CalcParser.EQUAL = 18;
CalcParser.GETKEY = 19;
CalcParser.INT = 20;
CalcParser.LOCATE = 21;
CalcParser.LOOPWHILE = 22;
CalcParser.MUL = 23;
CalcParser.OPAR = 24;
CalcParser.PI = 25;
CalcParser.SIN = 26;
...
CalcParser.RULE_vectorExpr = 12;
CalcParser.RULE_compOp = 13;
CalcParser.RULE_multOp = 14;
CalcParser.RULE_addOp = 15;
CalcParser.RULE_func = 16;
CalcParser.RULE_variable = 17;
CalcParser.RULE_constant = 18;
CalcParser.RULE_number = 19;
...
CalcParser.prototype.prog = function() {
    ...
    try {
        ...
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << CalcParser.ID) | (1 << CalcParser.UINT) | (1 << CalcParser.STRING) | (1 << CalcParser.ABS) | (1 << CalcParser.ACOS) | (1 << CalcParser.ASIN) | (1 << CalcParser.ATAN) | (1 << CalcParser.COS) | (1 << CalcParser.DO) | (1 << CalcParser.DOT) | (1 << CalcParser.GETKEY) | (1 << CalcParser.INT) | (1 << CalcParser.LOCATE) | (1 << CalcParser.OPAR) | (1 << CalcParser.PI) | (1 << CalcParser.SIN) | (1 << CalcParser.SQRT) | (1 << CalcParser.SUB) | (1 << CalcParser.TAN))) !== 0)) {
            this.state = 40;
            this.block();
            this.state = 45;
            this._errHandler.sync(this);
...
CalcParser.prototype.vectorExpr = function() {
    ...
    this.enterRule(localctx, 24, CalcParser.RULE_vectorExpr);
    try {
        this.state = 138;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
CalcParser.prototype.compOp = function() {
    ...
    this.enterRule(localctx, 26, CalcParser.RULE_compOp);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 140;
...
CalcParser.prototype.addOp = function() {
    ...
    this.enterRule(localctx, 30, CalcParser.RULE_addOp);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 144;
...
CalcParser.prototype.func = function() {
    ...
    this.enterRule(localctx, 32, CalcParser.RULE_func);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 146;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << CalcParser.ABS) | (1 << CalcParser.ACOS) | (1 << CalcParser.ASIN) | (1 << CalcParser.ATAN) | (1 << CalcParser.COS) | (1 << CalcParser.INT) | (1 << CalcParser.SIN) | (1 << CalcParser.SQRT) | (1 << CalcParser.TAN))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
CalcParser.prototype.variable = function() {
    ...
    this.enterRule(localctx, 34, CalcParser.RULE_variable);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 148;
...
CalcParser.prototype.constant = function() {
    ...
    this.enterRule(localctx, 36, CalcParser.RULE_constant);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 150;
...
CalcParser.prototype.number = function() {
    ...
    this.enterRule(localctx, 38, CalcParser.RULE_number);
    try {
        this.state = 158;
        this._errHandler.sync(this);
