...
var literalNames = [ null, "','", "'('", "')'", "'['", "']'", "'{'", "'}'", 
                     "':'", "'File Name'", "'%Header Record'", "'%Data Record'", 
                     "'%End'", null, null, null, null, null, "'0'", "'\\sqrt'", 
                     "'\\cos '", "'\\sin '", "'\\tan '", "'\\acos '", "'\\asin '", 
                     "'\\atan '", "'+'", "'-'", "'*'", "'/'", "'='", "'\\<>'", 
                     "'>'", "'\\>='", "'<'", "'\\<='", "'\\ And '", "'\\ Or '", 
                     "'\\->'", "'\\=>'", "'\\Else '", "'\\Goto'", "'\\If '", 
                     "'\\IfEnd'", "'\\Lbl '", "'\\List '", "'\\Locate '", 
                     "'\\Mat '", "'\\Pi'", "'\\Prog '", "'\\Return'", "'\\Then '" ];

var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, "ID", "NATNUM", "TEXT", "NEWLINE", 
                      "STRING", "ZERO", "SQRT", "COS", "SIN", "TAN", "ACOS", 
                      "ASIN", "ATAN", "ADD", "SUB", "MUL", "DIV", "EQ", 
                      "NE", "GT", "GE", "LT", "LE", "AND", "OR", "ARROW", 
                      "FATARROW", "ELSE", "GOTO", "IF", "IFEND", "LBL", 
                      "LIST", "LOCATE", "MATRIX", "PI", "PROG", "RETURN", 
                      "THEN" ];
...
CalcParser.T__11 = 12;
CalcParser.ID = 13;
CalcParser.NATNUM = 14;
CalcParser.TEXT = 15;
CalcParser.NEWLINE = 16;
CalcParser.STRING = 17;
CalcParser.ZERO = 18;
CalcParser.SQRT = 19;
CalcParser.COS = 20;
CalcParser.SIN = 21;
...
CalcParser.LBL = 44;
CalcParser.LIST = 45;
CalcParser.LOCATE = 46;
CalcParser.MATRIX = 47;
CalcParser.PI = 48;
CalcParser.PROG = 49;
...
CalcParser.RULE_listElement = 16;
CalcParser.RULE_listInitializer = 17;
...
CalcParser.RULE_matrix = 26;
CalcParser.RULE_list = 27;
CalcParser.RULE_variable = 28;
CalcParser.RULE_lbl = 29;
CalcParser.RULE_number = 30;
CalcParser.RULE_endStat = 31;
CalcParser.RULE_endProg = 32;
CalcParser.RULE_func = 33;
CalcParser.RULE_addOp = 34;
CalcParser.RULE_multOp = 35;
CalcParser.RULE_compOp = 36;
CalcParser.RULE_boolOp = 37;
...
CalcParser.prototype.prog = function() {
    ...
    try {
        ...
        case 1:
            ...
            while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << CalcParser.T__1) | (1 << CalcParser.T__3) | (1 << CalcParser.T__5) | (1 << CalcParser.ID) | (1 << CalcParser.NATNUM) | (1 << CalcParser.STRING) | (1 << CalcParser.ZERO) | (1 << CalcParser.SQRT) | (1 << CalcParser.COS) | (1 << CalcParser.SIN) | (1 << CalcParser.TAN) | (1 << CalcParser.ACOS) | (1 << CalcParser.ASIN) | (1 << CalcParser.ATAN) | (1 << CalcParser.SUB))) !== 0) || ((((_la - 41)) & ~0x1f) == 0 && ((1 << (_la - 41)) & ((1 << (CalcParser.GOTO - 41)) | (1 << (CalcParser.IF - 41)) | (1 << (CalcParser.LBL - 41)) | (1 << (CalcParser.LIST - 41)) | (1 << (CalcParser.LOCATE - 41)) | (1 << (CalcParser.MATRIX - 41)) | (1 << (CalcParser.PI - 41)) | (1 << (CalcParser.PROG - 41)) | (1 << (CalcParser.RETURN - 41)))) !== 0)) {
                this.state = 76;
                this.block();
                this.state = 81;
                this._errHandler.sync(this);
        ...
        case 2:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << CalcParser.T__1) | (1 << CalcParser.T__3) | (1 << CalcParser.T__5) | (1 << CalcParser.ID) | (1 << CalcParser.NATNUM) | (1 << CalcParser.STRING) | (1 << CalcParser.ZERO) | (1 << CalcParser.SQRT) | (1 << CalcParser.COS) | (1 << CalcParser.SIN) | (1 << CalcParser.TAN) | (1 << CalcParser.ACOS) | (1 << CalcParser.ASIN) | (1 << CalcParser.ATAN) | (1 << CalcParser.SUB))) !== 0) || ((((_la - 41)) & ~0x1f) == 0 && ((1 << (_la - 41)) & ((1 << (CalcParser.GOTO - 41)) | (1 << (CalcParser.IF - 41)) | (1 << (CalcParser.LBL - 41)) | (1 << (CalcParser.LIST - 41)) | (1 << (CalcParser.LOCATE - 41)) | (1 << (CalcParser.MATRIX - 41)) | (1 << (CalcParser.PI - 41)) | (1 << (CalcParser.PROG - 41)) | (1 << (CalcParser.RETURN - 41)))) !== 0)) {
                this.state = 82;
                this.block();
            }
...
CalcParser.prototype.listElement = function() {
    ...
    this.enterRule(localctx, 32, CalcParser.RULE_listElement);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 238;
...
CalcParser.prototype.listInitializer = function() {
    ...
    this.enterRule(localctx, 34, CalcParser.RULE_listInitializer);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 244;
...
CalcParser.prototype.attributes = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(_la===CalcParser.T__8 || _la===CalcParser.TEXT);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
CalcParser.prototype.matrix = function() {
    ...
    this.enterRule(localctx, 52, CalcParser.RULE_matrix);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 302;
        this.match(CalcParser.MATRIX);
...
CalcParser.prototype.list = function() {
    ...
    this.enterRule(localctx, 54, CalcParser.RULE_list);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 305;
        this.match(CalcParser.LIST);
...
CalcParser.prototype.variable = function() {
    ...
    this.enterRule(localctx, 56, CalcParser.RULE_variable);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 308;
        this.match(CalcParser.ID);
...
CalcParser.prototype.lbl = function() {
    ...
    this.enterRule(localctx, 58, CalcParser.RULE_lbl);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 310;
        this.match(CalcParser.ID);
...
CalcParser.prototype.number = function() {
    ...
    this.enterRule(localctx, 60, CalcParser.RULE_number);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 312;
...
CalcParser.prototype.endStat = function() {
    ...
    this.enterRule(localctx, 62, CalcParser.RULE_endStat);
    var _la = 0; // Token type
    try {
        this.state = 320;
        this._errHandler.sync(this);
...
CalcParser.prototype.endProg = function() {
    ...
    this.enterRule(localctx, 64, CalcParser.RULE_endProg);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 322;
...
CalcParser.prototype.addOp = function() {
    ...
    this.enterRule(localctx, 68, CalcParser.RULE_addOp);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 326;
...
CalcParser.prototype.multOp = function() {
    ...
    this.enterRule(localctx, 70, CalcParser.RULE_multOp);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 328;
...
CalcParser.prototype.compOp = function() {
    ...
    this.enterRule(localctx, 72, CalcParser.RULE_compOp);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 330;
        _la = this._input.LA(1);
        if(!(((((_la - 30)) & ~0x1f) == 0 && ((1 << (_la - 30)) & ((1 << (CalcParser.EQ - 30)) | (1 << (CalcParser.NE - 30)) | (1 << (CalcParser.GT - 30)) | (1 << (CalcParser.GE - 30)) | (1 << (CalcParser.LT - 30)) | (1 << (CalcParser.LE - 30)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
CalcParser.prototype.boolOp = function() {
    ...
    this.enterRule(localctx, 74, CalcParser.RULE_boolOp);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 332;
